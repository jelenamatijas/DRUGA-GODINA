...
{	
	...
	sale1->addItem(new Book("1984", 1000));
	sale1->addItem(new Book("Dune", 1000));
	// std::cout << *sale1 << std::endl;

	Sale* sale2 = new Sale;
	sale2->addItem(new Pen("Pen3", 25));
	sale2->addItem(new Pen("Pen4", 25));
	sale2->addItem(new Book("The Man Who Was Thursday", 1000));
	sale2->addItem(new Book("Charlotte's Web", 1000));

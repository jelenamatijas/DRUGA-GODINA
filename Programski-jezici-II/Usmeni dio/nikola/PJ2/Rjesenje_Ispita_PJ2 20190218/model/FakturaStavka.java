...
public class FakturaStavka implements ParserInterface<FakturaStavka> {
    public String sifra;
    ...
    public FakturaStavka(String sifra, String nazivProizvoda, double kolicina, double cijena) {
        this.sifra = sifra;
    ...
    @Override
    public FakturaStavka parse(String s) {
        String[] parts = s.split(",");
        return new FakturaStavka(parts[1], parts[2], Double.parseDouble(parts[3]), Double.parseDouble(parts[4]));
    }

...
public void run(){ //ako sinhronizujemo run prva nit koja udje(inace one se utrkuju jer nema join metode) zavrsice sve pa ce predati run metodu drugoj
...
new Thread(r).start();   //startujemo novi tred koji ispisuje 0 1 2 3 4 //ako izostavimo r necemo startovati redefinisanu run tj necemo startovati nist

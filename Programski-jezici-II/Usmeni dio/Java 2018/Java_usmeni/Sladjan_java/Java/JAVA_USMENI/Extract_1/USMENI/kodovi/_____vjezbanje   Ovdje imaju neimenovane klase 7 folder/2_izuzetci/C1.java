...
public class C1{
  ...
  Object metoda(C1 c) throws CE1{ //ako su u obje object klase c2 c nece radit,a ako su c1 radice jer kad 
                                  //prosledimo c2 ona sadrzi c1 obratno ne vrijedi
    if(c instanceof C1){
...
class C2 extends C1{
  ...
  Object metoda (C1 c) throws CE1{
    ...
    System.out.println("ulazak u metodu");

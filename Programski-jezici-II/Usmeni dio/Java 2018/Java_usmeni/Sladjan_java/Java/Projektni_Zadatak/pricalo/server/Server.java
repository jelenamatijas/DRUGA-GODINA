...
import Projektni_Zadatak.pricalo.server.ServerThreadRadnik;
...
public synchronized static void saveClientBase ()
{
  ...
  try
  {
    f = new File("Projektni_Zadatak"+File.separator + "pricalo" + File.separator + "server" + File.separator+ "base");
...
public synchronized static void readClientBase()
{
  ...
  try
  {
     f = new File("Projektni_Zadatak"+File.separator + "pricalo" + File.separator + "server" + File.separator+ "base" + File.separator + "RadniciBase.base");
     ...
     if (f.exists() && f.isFile())
     {
       ...
       for(String s : radniciRegistar.keySet()) System.out.println(s);
       System.out.println(radniciRegistar.size());

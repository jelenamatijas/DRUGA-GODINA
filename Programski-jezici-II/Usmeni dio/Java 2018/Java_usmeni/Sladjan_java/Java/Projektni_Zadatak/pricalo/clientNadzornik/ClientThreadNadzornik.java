package Projektni_Zadatak.pricalo.clientNadzornik;
    ...
    try
    {
      if (("OK").equalsIgnoreCase(readInput()))
      {
        ...
        do
        {
          ...
          else if ("2".equalsIgnoreCase(keyboardInput))searchByKeyword();
          else if ("3".equalsIgnoreCase(keyboardInput))messageReview();
          else if ("LOGOUT".equalsIgnoreCase(keyboardInput)) logedout = logout();
          else System.out.println("Nepravilno unesena opcija!!!");
        }
        while(!"1".equalsIgnoreCase(keyboardInput) && !"2".equalsIgnoreCase(keyboardInput) && !"LOGOUT".equalsIgnoreCase(keyboardInput) || !logedout);
      ...
      else
      {
        ...
        if (Integer.valueOf(keyboardInput) != 0)
        {
          for (int i=0;i<Integer.valueOf(keyboardInput);i++)
          {
            ...
            File q = new File("Projektni_Zadatak" + File.separator + "pricalo" + File.separator + "clientNadzornik" + File.separator + incomingFile);
            ...
            PrintWriter printMsgFile = new PrintWriter(new BufferedWriter(new FileWriter("Projektni_Zadatak" + File.separator + "pricalo"

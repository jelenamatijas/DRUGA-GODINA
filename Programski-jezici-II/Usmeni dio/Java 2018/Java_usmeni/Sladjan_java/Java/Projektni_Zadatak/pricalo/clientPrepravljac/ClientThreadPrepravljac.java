...
import Projektni_Zadatak.pricalo.clientPrepravljac.ClientPrepravljac;
...
public class ClientThreadPrepravljac extends Thread
{
    ...
    try
    {
      ...
      if("OK".equalsIgnoreCase(response))
      {
        ...
        do
        {
          ...
          if ("1".equalsIgnoreCase(keyboardInput))searchByJMB();
          else if ("LOGOUT".equalsIgnoreCase(keyboardInput)) logedout = logout();
   ...
   public boolean searchByJMB()
  {
    ...
    try
    {
      ...
      System.out.println("Ocitao broj fajlova");
      ...
      else
      {
        ...
        System.out.println("NumberOfFile je " + numberOfFile);
        ...
        out.println(keyboardInput);
            ...
            File q = new File("Projektni_Zadatak" + File.separator + "pricalo" + File.separator + "clientPrepravljac" + File.separator + "tempFile.txt");
            File nq = new File("Projektni_Zadatak" + File.separator + "pricalo" + File.separator + "clientPrepravljac" + File.separator + newFileName);
            ...
            PrintWriter printModified = new PrintWriter(new BufferedWriter(new FileWriter("Projektni_Zadatak" + File.separator + "pricalo"
            ...
            do
            {
              ...
              readFromTable = new BufferedReader(new FileReader("Projektni_Zadatak" + File.separator + "pricalo"
              ...
              if (!"##EOF##".equalsIgnoreCase(incomingFile))
              {
                ...
                do
                {
                  ...
                  if (contentFromTable != null)
                  {
                    ...
                    System.out.println("ContetntFromTable : " + contentFromTable);

...
public class AplikacijaZaObracunVremena {
 ...
 public static void main(String[] args) throws ClassNotFoundException {
  ...
  pv.sviZaposleni();
  System.out
    .println("Unesite 1 ukoliko niste registrovan zaposleni, u suprotnom unesite vase korisnicko ime!");
  ...
  if (temp.equals("1")) {
   ...
   System.out.println("Dobro dosli nazad korisnice "
     + korisnik.getKorisnickoIme());
  }
  System.out.println("Vase trenutno vrijeme koristenja je - "
    + korisnik.getBrojSati());

...
public class NaucneKonferencijeServer {
  public static void main(String[] args) {
    try {
      ...
      NaucneKonferencijeServant reader = new NaucneKonferencijeServant();
      ...
      System.out.println("NaucneKonferencijeServer is waiting for clients...");

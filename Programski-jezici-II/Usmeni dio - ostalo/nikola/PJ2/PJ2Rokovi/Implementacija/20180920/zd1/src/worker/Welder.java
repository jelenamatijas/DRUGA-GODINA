...
public class Welder extends Worker {
	...
	public Welder(String name, String surname){
		super(name, surname);
	}
	
	public boolean work(Item item) {
		if(item instanceof Box) 
			System.out.println(this + " vari kutiju " + item);
		else if(item instanceof Sheet)
			System.out.println(this + " vari plocu " + item);
		else {
			System.out.println(this + " ne moze da obradi objekat " + item);
			return false;
		}
		return true;
	}

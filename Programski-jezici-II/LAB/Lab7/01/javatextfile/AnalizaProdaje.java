...
public class AnalizaProdaje {
	...
	/*
	 * ULAZ racunar#pentium#1#1000; monitor#lg#2#200; racunar#amd#2#1050; ...
	 * 
	 * IZLAZ monitor 400 racunar 3100 ...
	 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			while ((s = in.readLine()) != null) {
				...
				int kolicina = Integer.parseInt(parametri[2]);
				double cijena = Double.parseDouble(parametri[3]);
				String kategorija = parametri[0];

				System.out.println("Proizvod " + parametri[1] + ", kategorija " + kategorija + ", cijena " + cijena
						+ ", kolicina " + kolicina);

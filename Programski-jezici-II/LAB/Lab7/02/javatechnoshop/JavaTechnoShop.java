...
public class JavaTechnoShop {
	...
	public static void main(String[] args) {
		...
		Monitor m1 = new Monitor("123",
				"    Screen size (inches)" + "    Panel Type 34" + "    Aspect Ratio IPS" + "    Resolution 21:9",
				"m100", 300.0, "Monitor LG 123", lg);

		Racunar r1 = new Racunar("Intel i3, RAM 4 GB, HDD 300 GB, Windows 7", "r100", 1025.5, "Laptop ThinkPad",
				lenovo);
		Racunar r2 = new Racunar("Intel i5, RAM 8 GB, HDD 500 GB, Windows 7", "r101", 1325.5, "Laptop ThinkPad",
				lenovo);
		Racunar r3 = new Racunar("Intel i7, RAM 16 GB, HDD 1 TB, Windows 7", "r102", 1625.5, "Laptop ThinkPad", lenovo);

		Telefon t1 = new Telefon("Galaxy S4", "RAM 2 GB, Super AMOLED capacitive touchscreen, 16M colors ", "t100", 800,
